...
.. note:: For a similar tutorial for **Fortran**, `see here <https://fortran-lang.org/learn/quickstart/variables/>`_.
...
When you are happy with your script, save it as `e001.py` and submit it via **Moodle**.
