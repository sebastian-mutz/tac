...
.. note:: For a similar tutorial for **Fortran**, see `here (arrays) <https://fortran-lang.org/learn/quickstart/arrays_strings/>`_ and `here (flow control) <https://fortran-lang.org/learn/quickstart/operators_control_flow/>`_.
...
.. code-block:: python
    ...
    g = [20.0, 15.0, -9999.0, 13.0, 17.0, 15.0, 20.0, 14.0, 19.0, 21.0]
...
When you are happy with your script, save it as *[your student number]_e001.[ext]* and submit it via **Moodle**.
