...
.. topic:: What to Submit
      ...
      Use the skeleton script below and add your lines of code where prompted. Submit the same script with your own code. The script should be named *a001c_[your student number].[ext]*, where *[ext]* is the file extension. In case of Python, this would be *.py*, for modern Fortran it is *.f90*, etc.
...
Fortran Skeleton Script
.......................

.. literalinclude:: ebm_skeleton.f90
   :language: fortran
